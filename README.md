...
- **Original Author**: [@tencent-weixin/openclaw-weixin](https://www.npmjs.com/package/@tencent-weixin/openclaw-weixin)
- **Reference Documentation**: [OpenClaw Plugin SDK Setup](https://github.com/openclaw/openclaw/blob/main/docs/plugins/sdk-setup.md)
