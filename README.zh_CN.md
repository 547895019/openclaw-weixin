...
- **原作者**: [@tencent-weixin/openclaw-weixin](https://www.npmjs.com/package/@tencent-weixin/openclaw-weixin)
- **参考文档**: [OpenClaw Plugin SDK 设置指南](https://github.com/openclaw/openclaw/blob/main/docs/plugins/sdk-setup.md)
